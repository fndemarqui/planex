...
dunnett <- emmeans(mod, dunnett ~ concentracao)
dunnett
```
...
```{r}
medias <- emmeans(mod, ~ tipo*temperatura)
medias

pairs(medias)

tipo <- emmeans(mod, ~ tipo|temperatura)
pairs(tipo)

temperatura <- emmeans(mod, ~ temperatura|tipo)
pairs(temperatura)  
